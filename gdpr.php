...
$texts = [
    'cs' => [
        ...
        'content' => '
            ...
            <ul>
                ...
                <li><strong>Analytika webu:</strong> Používáme analytické nástroje k analýze návštěvnosti. Tato data jsou anonymizována a pomáhají nám zlepšovat web.</li>
            </ul>
            ...
            <p>Vaše údaje neprodáváme. Přístup k nim máme my a naši prověření zpracovatelé (např. poskytovatel hostingu), kteří splňují přísné normy GDPR.</p>
    ...
    'en' => [
        ...
        'content' => '
            ...
            <ul>
                ...
                <li><strong>Website Analytics:</strong> We use analytical tools to monitor traffic. This data is anonymized and helps us improve our website.</li>
            </ul>
            ...
            <p>We do not sell your data. Access is restricted to us and trusted processors (e.g., hosting providers) who comply with GDPR.</p>
    ...
    'ru' => [
        ...
        'content' => '
            ...
            <ul>
                ...
                <li><strong>Аналитика сайта:</strong> Мы используем инструменты аналитики. Данные анонимизированы и помогают нам улучшать работу сайта.</li>
            </ul>
            ...
            <p>Мы не продаем ваши данные. Доступ имеют только наши сотрудники и проверенные партнеры (хостинг), соблюдающие GDPR.</p>
    ...
    'de' => [
        ...
        'content' => '
            ...
            <ul>
                <li><strong>Anfragen und Kommunikation:</strong> Wenn Sie uns kontaktieren, verarbeiten wir Ihren Namen, Ihre E-Mail und Nachricht zur Bearbeitung Ihrer Anfrage.</li>
                <li><strong>Webanalyse:</strong> Wir nutzen Analyse-Tools. Diese Daten sind anonymisiert und helfen uns, die Website zu verbessern.</li>
            </ul>
            ...
            <p>Wir verkaufen Ihre Daten nicht. Zugriff haben nur wir und vertrauenswürdige Auftragsverarbeiter (z. B. Hosting-Anbieter), die DSGVO-konform sind.</p>
    ...
    'uk' => [
        ...
        'content' => '
            ...
            <ul>
                ...
                <li><strong>Аналітика сайту:</strong> Ми використовуємо інструменти аналітики. Дані анонімізовані та допомагають нам покращувати роботу сайту.</li>
            </ul>
            ...
            <p>Ми не продаємо ваші дані. Доступ мають лише наші співробітники та перевірені партнери (хостинг), які дотримуються GDPR.</p>
